...
# from .views import ProductView,ProductDetailView,royalCanin,search_courses,CategoryDetailView
from . import views
urlpatterns = [

    # path("cart/",ProductView.as_view(),name="cart"),
    path('add-to-cart/<int:courseId>',views.add_to_cart,name="add-to-cart"),
